...
const signUpUser = async(req,res)=>{
    ...
    try {
        ...
        else res.cookie('token',token,{httpOnly:true,maxAge:60*60*24*7,sameSite:'none',secure:true,domain:'moments-frontend-netlify.netlify.app'})
...
const signOutUser = (req,res)=>{
    ...
    else res.clearCookie('token',{httpOnly:true,maxAge:60*60*24*7,sameSite:'none',secure:true,domain:'moments-frontend-netlify.netlify.app'})
